...
export default function Home() {
    return <main>
        ...
        <section className="py-16"><div className="mx-auto max-w-7xl px-5 sm:px-8"><Reveal><div className="border-[3px] border-primary bg-primary px-6 py-12 text-center text-paper comic-shadow-lg shadow-[8px_8px_0_var(--primary-strong)] sm:px-10"><h2 className="font-display text-4xl sm:text-5xl">Siap Gabung Angkatan Baru?</h2><p className="mx-auto mt-3 max-w-xl text-paper/85">Isi formulir pendaftaran online sekarang, cuma butuh 10 menit.</p><Link href="/ppdb/daftar" className="comic-button mt-7 inline-flex border-[3px] border-paper bg-paper px-6 py-3 font-bold text-primary shadow-[5px_5px_0_var(--primary-soft)]">Mulai Daftar</Link></div></Reveal></div></section>

        <footer className="border-t-[3px] border-ink py-10"><div className="mx-auto flex max-w-7xl flex-wrap justify-between gap-8 px-5 sm:px-8"><div><div className="font-display text-2xl">SMK BANI MASUM</div><p className="mt-2 text-sm leading-7 text-neutral-700">Subang, Jawa Barat<br />ppdb@banimasum.sch.id<br />(0260) 000-000</p></div><nav className="flex flex-wrap gap-5 text-sm font-bold"><Link href="/tentang">Tentang</Link><Link href="/jurusan">Jurusan</Link><Link href="/ppdb">PPDB</Link><Link href="/ppdb/cek-status">Cek Status</Link><Link href="/faq">FAQ</Link></nav></div><div className="mx-auto mt-8 max-w-7xl px-5 text-xs text-neutral-500 sm:px-8">© 2026 SMK Bani Masum. Semua hak dilindungi.</div></footer>
    </main>;
}
